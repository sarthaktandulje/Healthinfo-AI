...
| Datasets | Chest X-ray Dataset, HAM10000 |
...
> Always consult a **qualified medical professional** for real medical advice or diagnosis.
...
I am deeply interested in how **AI combined with Physics, Chemistry, and Mathematics** can solve real-world challenges — especially in **healthcare and social impact domains**.  
...
```bash
git clone https://github.com/sarthaktandulje/Healthinfo-AI.git
cd Healthinfo-AI
